...
public class Program
{
    public async static Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            await builder.AddApplicationAsync<AbpIssueModule>();
            var app = builder.Build();
            await app.InitializeApplicationAsync();

            if (IsMigrateDatabase(args))
            {
                await app.Services.GetRequiredService<AbpIssueDbMigrationService>().MigrateAsync();
                return 0;
            }
        ...
        catch (Exception ex)
        {
            ...
            Log.Fatal(ex, "AbpIssue terminated unexpectedly!");
            return 1;
        }
        finally
        {
